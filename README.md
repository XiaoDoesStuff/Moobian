# Moobian 
## Moobian is a cow themed Linux distro
             \ | /
           --- ☼ ---
             / | \
...
Current theming features include:
- A cow-themed GRUB background and font
...
Moobian includes a collection of built-in utility and installer scripts. These scripts are provided for software and tools that I personally use and recommend.
...
| Script | Description |
|----------|-------------|
| `Moobian-install-prismlauncher-minecraft` | Install|
| `Moobian-install-plex-client` | Install |
| `Moobian-install-MS-Edge` | Install |
| `Moobian-install-moonlight-game-streaming` | Install |
### Notes
...
- **[Debian Live-Build](https://github.com/debian-live/live-build)** - Powers the creation and customization of Moobian installation images.
- **[Linux Kernel Developers](https://github.com/torvalds/linux)** - Maintain the Linux kernel that serves as the foundation of the operating system.
 
